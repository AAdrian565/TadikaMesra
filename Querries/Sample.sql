...
VALUES  ('T000000001', '2022-01-01', 'K001', 'F001', 'M001', 'Siswa kelas 1A mengikuti ekskursi ke museum', 'Ekskursi ini sangat bermanfaat bagi pemahaman siswa tentang sejarah'),
        ...
        ('T000000010', '2022-10-01', 'K002', 'F010', 'M001', 'Siswa K002 mengikuti lomba menyanyi di sekolah', 'Siswa K002 berhasil meraih juara 2 dalam lomba menyanyi sekolah hari ini'),
        ('T000000011', '2022-10-01', 'K003', 'F010', 'M001', 'Siswa K003 mengikuti kegiatan ekstrakurikuler seni', 'Siswa K003 tampil sangat apik dalam kegiatan ekstrakurikuler seni hari ini'),
        ('T000000012', '2022-10-02', 'K001', 'F010', 'M001', 'Siswa K001 mengikuti kegiatan ekstrakurikuler bola', 'Semua siswa K001 tampil cemerlang dalam kegiatan ekstrakurikuler bola hari ini'),
        ('T000000013', '2022-10-02', 'K002', 'F010', 'M001', 'Siswa K002 mengikuti lomba menyanyi di sekolah', 'Siswa K002 berhasil meraih juara 2 dalam lomba menyanyi sekolah hari ini'),
        ('T000000014', '2022-10-02', 'K003', 'F010', 'M001', 'Siswa K003 mengikuti kegiatan ekstrakurikuler seni', 'Siswa K003 tampil sangat apik dalam kegiatan ekstrakurikuler seni hari ini'),
        ('T000000015', '2022-10-03', 'K001', 'F010', 'M001', 'Siswa K001 mengikuti kegiatan ekstrakurikuler bola', 'Semua siswa K001 tampil cemerlang dalam kegiatan ekstrakurikuler bola hari ini'),
        ('T000000016', '2022-10-03', 'K002', 'F010', 'M001', 'Siswa K002 mengikuti lomba menyanyi di sekolah', 'Siswa K002 berhasil meraih juara 2 dalam lomba menyanyi sekolah hari ini'),
        ('T000000017', '2022-10-03', 'K003', 'F010', 'M001', 'Siswa K003 mengikuti kegiatan ekstrakurikuler seni', 'Siswa K003 tampil sangat apik dalam kegiatan ekstrakurikuler seni hari ini'),
        ('T000000018', '2022-01-15', 'K001', 'F001', 'M001', 'Siswa K001 melakukan kegiatan belajar mengajar di kelas', 'Semua siswa K001 tampak fokus dalam belajar'),
        ('T000000019', '2022-01-15', 'K002', 'F002', 'M002', 'Siswa K002 melakukan ekskul basket', 'Siswa K002 tampak aktif dalam ekskul basket'),
        ('T000000020', '2022-01-15', 'K003', 'F003', 'M003', 'Siswa K003 melakukan kegiatan belajar mengajar di kelas', 'Semua siswa K003 tampak fokus dalam belajar'),
        ('T000000021', '2022-01-16', 'K001', 'F004', 'M004', 'Siswa K001 melakukan ekskul seni', 'Siswa K001 tampak antusias dalam ekskul seni'),
        ('T000000022', '2022-01-16', 'K002', 'F005', 'M005', 'Siswa K002 melakukan kegiatan belajar mengajar di kelas', 'Semua siswa K002 tampak fokus dalam belajar'),
        ('T000000023', '2022-01-16', 'K003', 'F006', 'M006', 'Siswa K003 melakukan ekskul musik', 'Siswa K003 tampak aktif dalam ekskul musik'),
        ('T000000024', '2022-01-17', 'K001', 'F007', 'M007', 'Siswa K001 melakukan kegiatan belajar mengajar di kelas', 'Semua siswa K001 tampak fokus dalam belajar'),
        ('T000000025', '2022-01-17', 'K002', 'F008', 'M008', 'Siswa K002 melakukan ekskul olahraga', 'Siswa K002 tampak aktif dalam ekskul olahraga'),
        ('T000000026', '2022-01-17', 'K003', 'F009', 'M009', 'Siswa K003 melakukan kegiatan belajar mengajar di kelas', 'Semua siswa K003 tampak fokus dalam belajar'),
        ('T000000027', '2022-07-10', 'K001', 'F006', 'M006', 'Siswa kelas 1A melakukan diskusi dalam kelas tentang materi sejarah', 'Siswa kelas 1A cukup aktif dalam diskusi dan menunjukkan hasil yang baik dalam pemahaman materi'),
        ('T000000028', '2022-07-10', 'K002', 'F007', 'M007', 'Siswa kelas 1B melakukan presentasi dalam kelas tentang materi biologi', 'Siswa kelas 1B cukup kompeten dalam menyajikan presentasi dan memahami materi'),
        ('T000000029', '2022-07-10', 'K003', 'F008', 'M008', 'Siswa kelas 2A mengikuti lomba olimpiade matematika tingkat sekolah', 'Siswa kelas 2A berhasil meraih juara 2 dalam lomba olimpiade matematika'),
        ('T000000030', '2022-07-10', 'K004', 'F009', 'M009', 'Siswa kelas 2B melakukan eksperimen dalam kelas tentang materi kimia', 'Siswa kelas 2B cukup aktif dalam melakukan eksperimen dan menunjukkan hasil yang baik dalam pemahaman materi');
